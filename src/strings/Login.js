export default {
  // texts
  login__bar__title: 'Connectez-vous à votre compte Minecraft',
  login__bar__username: "Nom d'utilisateur",
  login__bar__password: 'Mot-de-passe',
  login__bar__remember_me: ' Se souvenir de moi',
